...
;(function()
{
    ...
    function Brush()
    {
        ...
        this.regexList = [
                        ...
                        { regex: new RegExp('\\b_*(NS|UI|CG|SC|AB|AV|MF|AL|AT|WK|SK|PK|EAGL|Sec|Audio)[A-Z]\\w+\\b', 'g'),    css: 'color4' },                // builtInType purple
                        { regex: new RegExp('\\b_*(dispatch_)[a-zA-Z0-9_]+_t\\b', 'g'), css: 'color4' },                // builtInType purple
